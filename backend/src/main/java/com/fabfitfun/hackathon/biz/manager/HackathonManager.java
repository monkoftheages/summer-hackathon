...
public class HackathonManager {
  ...
  public String manageData(String queryKeyword, Long shopUserId) {
    SentimentAnalysisResource sentimentAnalysis = new SentimentAnalysisResource(shopUserId, queryKeyword);
